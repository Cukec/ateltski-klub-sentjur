...
if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST['action'])) {
    $action = $_POST['action'];
    $id = isset($_POST['relays']) ? (int)$_POST['relays'] : 0;
            ...
            if ($id > 0) {
                ...
                try {
                    ...
                    if ($stmt_people->execute()) {
                        ...
                        $conn->commit();
                        $msgs[] = "Štafeta uspešno izbrisana in vse povezane podatke!";
                    } else {
                        throw new Exception("Napaka pri brisanju štafete.");
                    }
                    ...
                    $conn->rollback();
                    $msgs[] = "Napaka pri brisanju štafete! Poskusite znova...";
                }
            } else {
                $msgs[] = "Napaka: Neveljaven ID osebe.";
            }
...
<head>
    ...
    <title>AK Šentjur - urejanje štafet</title>
...
if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST['action'])) {
    ...
    if ($action === "save") {
        ...
        <form action="add-relay.php" method="POST">
            <div class="form-div">
                ...
                <div>
                    ...
                    <select name="people[]" id="people" multiple size="5">
        ...
        <div class="form-div">
            ...
            <div class="inline">
                <div>
                    <label for="selection">Selekcije štafete</label>
                    <select name="selection[]" id="selection" multiple size="5">
                        <?php
                ...
                <div>
                    <label for="discipline">Discipline štafete</label>
                    <select name="discipline[]" id="discipline" multiple size="5">
                        <?php
